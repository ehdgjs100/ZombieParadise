...
public class BossZombieController : MonoBehaviour
{
    ...
    [SerializeField] GameObject shortWeaponGo;
    ...
    IEnumerator LongAttack0()
    {
        ...
        _zombieAnimator.SetTrigger("swordAttack1");
        shortWeaponGo.GetComponent<BoxCollider>().enabled = true;

        yield return new WaitForSeconds(4.0f);
        shortWeaponGo.GetComponent<BoxCollider>().enabled = false;
